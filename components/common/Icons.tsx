...
export const ReflectionsIcon = () => (
    <IconWrapper>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v11.494m-5.25-11.494v11.494L12 21.747l5.25-3.999V6.253L12 2.253 6.75 6.253z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v11.494m-5.25-11.494v11.494L12 21.747l5.25-3.999V6.253L12 2.253 6.75 6.253z" />
    </IconWrapper>
);
...
export const DreamIcon = () => (
    <IconWrapper>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.32 1.011l-4.218 4.105a.563.563 0 00-.162.524l1.28 5.385c.12.502-.434.902-.875.644l-4.998-2.902a.563.563 0 00-.54 0l-4.998 2.902c-.44.258-1.001-.14-1.12-.644l1.28-5.385a.563.563 0 00-.162.524l-4.218-4.105c-.38-.348-.18-.97.32-1.011l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
    </IconWrapper>
);

export const GoalIcon = () => (
    <IconWrapper>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.63 2.131A14.98 14.98 0 003.47 14.37m6.16-12.12v3.375m6.16-3.375L10.8 11.25" />
    </IconWrapper>
);
